    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="card-header py-1 text-left">
          <h5 class="m-0">承造廠商專任工程人員資料</h5>
        </div>
        <div class="mt-2">
          <i-button type="file-earmark-plus" @click="toCreate"></i-button>
          <b-button style="background-color: #1aa4b7">專任工程人員記錄表</b-button>
        </div>
        <div class="mt-2">
          <i-table
            class="table-sm"
...
export default {
  ...
  setup(props, context) {
    ...
    function toCreate() {
      ...
      navigateByNameAndParams('bidAac002Edit', { bidProjectKey, formStatus: 'create' });
    }
    ...
    function toModify() {
      ...
      navigateByNameAndParams('bidAac002Edit', { bidProjectKey, formStatus: 'modify' });
    }
