...
export default {
  ...
  setup(props, context) {
    ...
    function toCreate() {
      ...
      navigateByNameAndParams('bidAac006Edit', { bidProjectKey, formStatus: 'create' });
    }
    ...
    function toModify() {
      ...
      navigateByNameAndParams('bidAac006Edit', { bidProjectKey, formStatus: 'modify' });
    }
