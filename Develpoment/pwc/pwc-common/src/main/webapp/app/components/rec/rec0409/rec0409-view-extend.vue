          ...
          <div>
            ...
            <b-form-row>
              <i-form-group-check class="col-10" :label="$t('label.handlingStatus')" :item="$v.handlingStatus">
                <b-form-textarea rows="10" cols="100" maxlength="4000" v-model="$v.defauleHandling.$model" disabled>
                  <!-- 決標日期： 契約開工日期： 契約完工日期： 實際開工日期： 預定完工日期： 不計工期天數： 原因分析： -->
                </b-form-textarea>
              </i-form-group-check>
            </b-form-row>
            <b-form-row>
              <i-form-group-check class="col-10" :label="$t('label.extensionCondition')" :item="$v.extensionCondition" disabled>
                <b-form-select :options="queryOptions.extensionCondition"></b-form-select>
              </i-form-group-check>
            </b-form-row>
            <b-form-row class="mt-3">
              <i-form-group-check class="col-10" :label="$t('label.approvedDeadline')" :item="$v.approvedDeadline" :labelStar="true" disabled>
                <b-form-input value="2021.4.21"> </b-form-input>
              </i-form-group-check> </b-form-row
            ><b-form-row>
              <i-form-group-check class="col-10" :label="$t('label.opinions')" :item="$v.opinions" disabled>
