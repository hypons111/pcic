    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="mt-2">
          ...
          <b-button style="background-color: #1aa4b7">工地人員記錄表</b-button>
        </div>
        <div class="mt-2">
          <i-table
            class="table-sm"
...
export default {
  ...
  setup(props, context) {
    ...
    function toCreate() {
      ...
      navigateByNameAndParams('bidAac003Edit', { bidProjectKey, formStatus: 'create' });
    }
    ...
    function toModify() {
      ...
      navigateByNameAndParams('bidAac003Edit', { bidProjectKey, formStatus: 'modify' });
    }
