    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="card-header">
          <h5 class="m-0">承造廠商專任工程人員詳細資料</h5>
        </div>
        <div class="mt-2">
          <b-form-row>
          ...
          <b-form-row>
            <i-form-group-check :label="'身分證號: '" :label-cols="2" :content-cols="10" class="col-12" :labelStar="true">
              ...
              <b-button class="btn-sm ml-1" style="background-color: #1aa4b7">專任工程人員</b-button>
          ...
          <b-form-row>
            <i-form-group-check :label="'證照種類: '" :label-cols="2" :content-cols="10" class="col-12" :labelStar="true">
              <b-form-select class="col-4" :options="formOptions.job"></b-form-select>
            </i-form-group-check>
          </b-form-row>
...
export default {
  ...
  setup(props, context) {
    ...
    const formOptions = reactive({
      job: [
        { value: '', text: '請選擇(BID020)' },
        { value: '1', text: '1:建築師' },
        { value: '2', text: '2:技師' },
        { value: '2', text: '3:專業工程人員' },
      ],
      duty: [
        { value: '', text: '請選擇(BID031)' },
        { value: '1', text: '1:在職' },
        { value: '2', text: '2:中途離職' },
    ...
    const submitForm = () => {
      ...
      navigateByNameAndParams('bidAac002Info', { bidProjectKey });
    };
