      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <b-form-row>
            ...
            <!-- 執行機關 -->
            <i-form-group-check :label="$t('label.wkut') + '：'">
...
export default {
  ...
  setup(props) {
    ...
    function toLast() {
      navigateByNameAndParams('Eng0305Query', {
    ...
    const data = {
      caseNum: 'B101060',
      caseType: '機關自辦',
      caseNa: '曾文溪尖山堤防防災減災工程',
      orgId: '3.13.20.16-5',
      orgName: '經濟部水利署第六河川局',
      execOrgId: '3.13.20.16-5',
      wkutName: '經濟部水利署第六河川局',
      contactPerson: '經濟部水利署第六河川局工務課',
      contactTel: '07-6279011',
      serviceContent: '',
      tenderDate: '99/01/01',
      ctSum: '2,075,500',
      execDateStart: '101/07/01',
      execDateEnd: '101/12/31',
    ...
    const compData = [
      {
        no: 1,
        agentName: '經濟部水利署第六河川局',
        compIdno: '3.13.20.16-5',
        caslicenseNoeNo: '',
        execDateStart: '101/07/01',
        execDateEnd: '101/12/31',
      },
