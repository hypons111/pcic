  ...
  <div>
    <section class="container mt-2">
      <div class="card">
        ...
        <p>本年度服務費完成金額總計:{{ data1.yearCompletePrice }}元</p>
      </div>
    </section>
    <section class="container mt-2">
      <div class="card">
...
export default {
  ...
  setup(prop) {
    ...
    const data = [
      {
        no: 1,
        compName: '恆揚工程顧問有限公司 (統編:)',
        caseName: '中央自動車道與瀨第一橋樑基本設計BridgeSuperstructureBasicDesign',
        clientName: 'Nippatsugiken Co. Lt',
        serviceCasePrice: '2,036,967',
        yearCompletePrice: '673,980',
        ...
        engrSubjectNameIdno: '',  // 提醒自己這邊有個table
    ...
    const data2 = [
      {
        ...
        engrName: '黃斌修',
        engrIdno: 'F12073****',
        dateStart: new Date(2020, 3, 10),
        dateEnd: new Date(2020, 9, 30),
        mainTask: '橋樑設計',
      }
    ]
