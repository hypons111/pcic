  ...
  <b-container>
    <b-row align-h="center">
      <b-col cols="11">
        ...
        <h5 class="font-weight-bold text-decoration-underline">工程技術顧問公司相關資訊</h5>
        <table>
          <tr>
            <td>授權機構名稱(委託方)：</td>
          ...
          <tr>
            <td>董事長或代表人姓名：</td>
            <td class="font-weight-bold">{{ $v.masterName.$model }}</td>
          </tr>
          <tr>
            <td>營利事業統一編號：</td>
            <td class="font-weight-bold">{{ $v.compIdno.$model }}</td>
          </tr>
          <tr>
            <td>被授權人(受任方)：</td>
        ...
        <p>
          &emsp;&emsp;本同意授權服務書說明行政院公共工程委員會（以下簡稱工程會）將如何處理所蒐集到的貴公司相關財稅資料，當您勾選「同意授權」時，表示您已閱讀瞭解並同意接受本同意書之所有內容及其後修改變更規定，若您非工程技術顧問公司之董事長或代表人，應請工程技術顧問公司之董事長或代表人閱讀瞭解，並同意本同意書之所有內容及其後修改變更規定後，方得使用本服務，但若您已接受本服務，視為您已取得工程技術顧問公司之董事長或代表人之同意，並遵守以下所有規範：
        </p>
        ...
        <table class="mb-3" style="margin-left: -10px">
          <tr>
            <td valign="top">（一）</td>
            <td>
              委託方因故未填報年度業務報告書之「營業收入」及「非營業收入」欄位，特同意委託工程會蒐集及利用委託方之<span
          ...
          <tr>
            <td valign="top">（二）</td>
            <td>
              授權範圍包含：委託方之營利事業所得稅結算申報書表「年度損益及稅額計算表」項目<span style="font-weight: bold"
                >「<span style="text-decoration: underline">01營業收入總額</span>」</span
              >及<span style="font-weight: bold">「<span style="text-decoration: underline">34非營業收入總額</span>」</span>。
            </td>
          </tr>
          <tr>
            <td valign="top">（三）</td>
            <td>
              委託方原應依工程技術顧問公司管理條例第二十一條第一項於年度結束之次日起六個月內，檢具主管機關規定之年度業務報告書，送主管機關備查。<span
                style="font-weight: bold; text-decoration: underline; color: red"
                >委託方如同意將「營業收入」及「非營業收入」內容授權工程會向財政部查調欄位財稅資料，上開二項授權欄位將視為已完成填報</span
              >。
            </td>
          </tr>
          <tr>
