    ...
    <section class="container">
      <div class="card">
        ...
        <div class="card-body">
          <b-form-row>
            <!-- 發文日期 -->
            <i-form-group-check content-cols="4" :label="$t('label.postDate') + '：'" :item="$v.publicDate">
          ...
          <b-form-row>
            <!-- 根據技師法 -->
            <i-form-group-check class="col-12" label-cols="2" content-cols="4" :label="$t('label.Regulations') + '：'" :item="$v.baseOn">
