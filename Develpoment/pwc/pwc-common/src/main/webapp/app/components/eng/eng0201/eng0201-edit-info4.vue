...
<div>
  ...
  <b-form-row>
    <b-col offset="5">
      ...
      @click="toEditView('Eng0201EditInfo4_1', FormStatusEnum.CREATE)"> 
      </i-button>
    </b-col>
  </b-form-row>
  <section class="container mt-2" v-show="queryStatus">
    <i-table
      ...
      <template #cell(action)="row">
        <!-- 編輯 -->
          <i-button @click="toEditView('Eng0201EditInfo4_1', FormStatusEnum.EDIT, row.index)"
            v-if="
