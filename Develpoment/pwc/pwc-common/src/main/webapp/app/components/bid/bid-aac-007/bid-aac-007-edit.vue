<template>
  <div>
    ...
    <div class="card">
      ...
      <b-form-row>
        <i-form-group-check :label="'現場人員身分證號: '" :label-cols="2" :content-cols="10" class="col-12" :labelStar="true">
      ...
      <b-form-row>
        <i-form-group-check :label="'現場人員姓名: '" :label-cols="2" :content-cols="10" class="col-12">廖昱奇 </i-form-group-check>
      </b-form-row>
      <b-form-row>
      ...
      <b-form-row>
        <i-form-group-check :label="'現場人員行動電話: '" :label-cols="2" :content-cols="10" class="col-12" :labelStar="true">
          <b-form-input class="col-4"></b-form-input>
        </i-form-group-check>
      </b-form-row>
      <b-form-row>
