...
import gov.pcc.pwc.repository.custom.MrpSysCodeRepositoryCustom;
...
public class MrpSysCodeRepositoryImpl implements MrpSysCodeRepositoryCustom {
    ...
    public MrpSysCodeRepositoryImpl(SqlExecutor sqlExecutor, OdsExportService odsExportService, SerialNumGenerator serialNumGenerator) {
