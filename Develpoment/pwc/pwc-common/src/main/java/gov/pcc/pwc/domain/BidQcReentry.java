 ...
 */
@Entity
@Table(name = "bid_qc_reentry")
public class BidQcReentry implements Serializable {
    ...
    public BidQcReentry id(String id) {
        this.setId(id);
        return this;
    }
    ...
    public BidQcReentry fullTime(String fullTime) {
    ...
    public BidQcReentry reStartDate(LocalDate reStartDate) {
    ...
    public BidQcReentry reEndDate(LocalDate reEndDate) {
    ...
    public BidQcReentry createDate(Instant createDate) {
    ...
    public BidQcReentry createUser(String createUser) {
    ...
    public BidQcReentry updateDate(Instant updateDate) {
    ...
    public BidQcReentry updateUser(String updateUser) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BidQcReentry)) {
            return false;
        }
        return id != null && id.equals(((BidQcReentry) o).id);
    }
