...
public class AnalysisSemanic implements Serializable {
    ...
    public AnalysisSemanic mrpSynonymId(Long mrpSynonymId) {
    ...
    public AnalysisSemanic sectionName(String sectionName) {
    ...
    public AnalysisSemanic keyword(String keyword) {
    ...
    public AnalysisSemanic phrase(String phrase) {
    ...
    public AnalysisSemanic updateId(String updateId) {
    ...
    public AnalysisSemanic updateDate(Instant updateDate) {
    ...
    public AnalysisSemanic createId(String createId) {
    ...
    public AnalysisSemanic createDate(Instant createDate) {
    ...
    public AnalysisSemanic dataKeyType(String dataKeyType) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AnalysisSemanic)) {
            return false;
        }
        return mrpSynonymId != null && mrpSynonymId.equals(((AnalysisSemanic) o).mrpSynonymId);
    }
