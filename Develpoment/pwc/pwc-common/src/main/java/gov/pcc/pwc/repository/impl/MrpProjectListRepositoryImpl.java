...
import gov.pcc.pwc.repository.custom.MrpProjectListRepositoryCustom;
...
public class MrpProjectListRepositoryImpl implements MrpProjectListRepositoryCustom {
    ...
    public MrpProjectListRepositoryImpl(SqlExecutor sqlExecutor, OdsExportService odsExportService, SerialNumGenerator serialNumGenerator) {
