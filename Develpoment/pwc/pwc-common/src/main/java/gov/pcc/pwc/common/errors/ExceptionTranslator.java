...
import gov.pcc.pwc.service.UsernameAlreadyUsedException;
import java.net.URI;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        gov.pcc.pwc.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        gov.pcc.pwc.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    @ExceptionHandler
    public ResponseEntity<BidErrorResponse> handleBidValidationFailException(BidValidationFailException ex){
        HttpStatus status = HttpStatus.BAD_REQUEST;
        return new ResponseEntity<>(
                new BidErrorResponse(ex.getMessage(),ex.getErrorKey(), ex.getDetailMessages()), status
        );
    }
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "gov.pcc.pwb");
    }
}
