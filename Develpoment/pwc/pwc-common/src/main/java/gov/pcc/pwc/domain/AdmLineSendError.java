 ...
 */
@Entity
@Table(name = "adm_line_send_error")
public class AdmLineSendError implements Serializable {
    ...
    public AdmLineSendError id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public AdmLineSendError realSendTime(Instant realSendTime) {
    ...
    public AdmLineSendError sender(String sender) {
        this.sender = sender;
        return this;
    }
    ...
    public AdmLineSendError receiver(String receiver) {
    ...
    public AdmLineSendError message(String message) {
    ...
    public AdmLineSendError errorMessage(String errorMessage) {
    ...
    public AdmLineSendError createUser(String createUser) {
    ...
    public AdmLineSendError createTime(Instant createTime) {
    ...
    public AdmLineSendError updateUser(String updateUser) {
    ...
    public AdmLineSendError updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdmLineSendError)) {
            return false;
        }
        return id != null && id.equals(((AdmLineSendError) o).id);
    }
