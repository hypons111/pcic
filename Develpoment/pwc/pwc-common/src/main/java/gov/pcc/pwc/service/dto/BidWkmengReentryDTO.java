...
/**
 * A DTO for the {@link gov.pcc.pwc.domain.BidWkmengReentry} entity.
 */
public class BidWkmengReentryDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BidWkmengReentryDTO)) {
            return false;
        }

        BidWkmengReentryDTO bidWkmengReentryDTO = (BidWkmengReentryDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, bidWkmengReentryDTO.id);
    }
