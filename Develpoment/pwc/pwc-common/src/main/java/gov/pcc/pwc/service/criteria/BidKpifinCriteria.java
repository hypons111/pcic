...
public class BidKpifinCriteria extends Criteria<BidKpifin> {

    private String wkut;
    private String prjno;

    public BidKpifinCriteria() {}

    public BidKpifinCriteria(String wkut, String prjno) {
        this.wkut = wkut;
        this.prjno = prjno;
        setDefaultSorBy();
    }
    ...
    @Override
        ...
        return criteriaBuilder.and(
                ...
                criteriaBuilder.equal(root.get("flag"),"Y")
                );
    }
