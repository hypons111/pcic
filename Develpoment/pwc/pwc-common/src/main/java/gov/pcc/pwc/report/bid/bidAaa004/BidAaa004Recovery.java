...
public class BidAaa004Recovery extends AbstractReport {

    public BidAaa004Recovery() {
        super(BidReport.BidAaa004Recovery);
    }
    ...
    public Map<String, Object> toJasperParams() {
        ...
        map.put("endDate", bidPrjStopwkDTO.getEndDate() != null ? parseLocalDateToYYYMMDD(bidPrjStopwkDTO.getEndDate()) : "(未填)");
