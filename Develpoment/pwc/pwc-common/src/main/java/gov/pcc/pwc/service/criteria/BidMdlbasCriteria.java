...
public class BidMdlbasCriteria extends Criteria<BidMdlbas> {
    private String wkut;
    ...
    public boolean equals(Object obj) {
        ...
        BidMdlbasCriteria that = (BidMdlbasCriteria) obj;
        return (
                //與傳入值比較
                Objects.equal(wkut, that.wkut)
                        && Objects.equal(disNo, that.disNo)
                        && Objects.equal(isAdd92, that.isAdd92)
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(wkut, disNo,isAdd92);
    }
    ...
    @Override
    public Predicate toPredicate(Root<BidMdlbas> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
        return null;
    }
}
