...
public class BidAae030B extends AbstractReport {

    public BidAae030B() {
        super(BidReport.BidAae030B);
    }
    ...
    protected List<Map<String, Object>> convertToDataList() {
        ...
        if(bidPrjWksorcDTO != null && bidPrjWksorcDTO.size() >0) {
            for (BidPrjWksorcDTO item : bidPrjWksorcDTO) {
                ...
                map1.put("ajobtype01", item.getAjobtype01());
                map1.put("ajobtype02", item.getAjobtype02());
                map1.put("ajobtype03", item.getAjobtype03());
                map1.put("ajobtype04", item.getAjobtype04());
                map1.put("ajobtype05", item.getAjobtype05());
                map1.put("ajobtype06", item.getAjobtype06());
                map1.put("ajobtype07", item.getAjobtype07());
                map1.put("ajobtype08", item.getAjobtype08());
                map1.put("ajobtype09", item.getAjobtype09());
                map1.put("ajobtype10", item.getAjobtype10());
                map1.put("ajobtype11", item.getAjobtype11());
                map1.put("ajobtype12", item.getAjobtype12());
                map1.put("ajobtype13", item.getAjobtype13());
                map1.putAll(map);
                list.add(map1);
            }
        }
