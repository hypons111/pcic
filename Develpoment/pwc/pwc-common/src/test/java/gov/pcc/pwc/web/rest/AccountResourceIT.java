...
import static gov.pcc.pwc.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import gov.pcc.pwc.repository.AuthorityRepository;
...
import gov.pcc.pwc.service.dto.PasswordChangeDTO;
import gov.pcc.pwc.web.rest.vm.KeyAndPasswordVM;
import gov.pcc.pwc.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        jhiUserService.createUser(user);
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        jhiUserService.updateUser((new AdminUserDTO(testUser4.get())));
