...
/**
 * Integration tests for {@link JhiUserService}.
 */
@IntegrationTest
@Transactional
class JhiUserServiceIT {
    ...
    void assertThatUserMustExistToResetPassword() {
        ...
        Optional<User> maybeUser = jhiUserService.requestPasswordReset("invalid.login@localhost");
        assertThat(maybeUser).isNotPresent();
        //maybeUser = jhiUserService.requestPasswordReset(user.getEmail());
    ...
    void assertThatOnlyActivatedUserCanRequestPasswordReset() {
        ...
        Optional<User> maybeUser = jhiUserService.requestPasswordReset(user.getLogin());
        assertThat(maybeUser).isNotPresent();
    ...
    void assertThatResetKeyMustNotBeOlderThan24Hours() {
        ...
        Optional<User> maybeUser = jhiUserService.completePasswordReset("johndoe2", user.getResetKey());
        assertThat(maybeUser).isNotPresent();
        userRepository.delete(user);
    }
    ...
    void assertThatNotActivatedUsersWithNotNullActivationKeyCreatedBefore3DaysAreDeleted() {
        ...
        //jhiUserService.removeNotActivatedUsers();
