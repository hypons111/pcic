...
public class AdmCodeTableResource {
    ...
    public ResponseEntity<AdmCodeTable> updateAdmCodeTable(
        ...
        if (admCodeTableRepository.findByCategoryAndCode(admCodeTable.getCategory(), admCodeTable.getCode()) != null
            && !Objects.equals(admCodeTable.getId(), admCodeTableRepository.findByCategoryAndCode(admCodeTable.getCategory(), admCodeTable.getCode()).getId())) {
    ...
    public AdmCodeTableDTO getAdmCodeTable(@PathVariable Long id) {
        ...
        return admCodeTableService.findByPk(id);
    }
    ...
    @GetMapping("/service/adm-code-table/i18n")
    public Map<String, Map<String, Map<String, String>>> getAllAdmCodeTables() {
        log.debug("REST request to get i18n");
        return admCodeTableService.getI18n();
    }
}
