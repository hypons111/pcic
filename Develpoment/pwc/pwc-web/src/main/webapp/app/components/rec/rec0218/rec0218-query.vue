    ...
    const handleQuery = () => {
      checkValidity().then((isValid: boolean) => {
        if (isValid) {
          ...
          table.data = [
            {
              typhoonName: '106年7月尼莎及海棠颱風',
              approveNo: '008',
              typeCode: 'G1',
              agencyName: '屏東縣政府',
              recEngName: '(106年7月尼莎及海棠颱風)春日鄉古華村屏142線旁野溪災修復建工程',
              city: '春日鄉',
              village: '春日村', 
              reviewAmount: '0',
              bidProgress: '0.00%',
              scheduledFinishDate: '2018.04.01',
              bidDate: '2017.12.19',
              aeDate: '2018.05.04'        
            },
            {
            ...
            {
              typhoonName: '107年8月豪雨',
              approveNo: '011',
              typeCode: 'H3',
              agencyName: '屏東縣政府',
              recEngName: '(107年8月豪雨)春日鄉布七農路災修復建工程',
              city: '春日鄉',
              village: '春日村', 
              reviewAmount: '0',
              bidProgress: '',
              scheduledFinishDate: '2019.04.25',
              bidDate: '',
              aeDate: ''        
            },
          ];
