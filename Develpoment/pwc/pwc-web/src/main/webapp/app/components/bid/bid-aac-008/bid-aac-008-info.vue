  ...
  <div>
    ...
    <div class="card">
      <div class="card-header">
        <h5 class="m-0">規劃設計監造專技人員資料</h5>
      
      <div class="mt-2">
        <i-button type="file-earmark-plus" @click="toCreate"></i-button>
        <b-button style="background-color: #1aa4b7">規劃設計監造專技人員表</b-button>
      </div>
      ...
      <i-table
        ...
        >
          ...
          <template #cell(action)>
            <i-button class="btn-sm" type="pencil-square" @click="navigateByNameAndParams('bidAac008Edit',{})"></i-button>
          </template>
        </i-table>
    </div>
  </div>
