        ...
        <div class="mt-2">
          ...
          <b-form-row>
            <i-form-group-check :label="'職稱: '" :labelStar="true" :label-cols="2" :content-cols="10" class="col-12">
              <b-form-select class="col-3" :options="formOptions.job"></b-form-select>
              <b-form-select class="col-3" :options="formOptions.workType"></b-form-select>
              <b-form-select class="col-3" :options="formOptions.sworkType"></b-form-select>
              <b-form-select class="col-3" :options="formOptions.jobType"></b-form-select>
            </i-form-group-check>
          </b-form-row>
...
export default {
  ...
  setup(props, context) {
    ...
    const formOptions = reactive({
      job: [{ value: '', text: '技術士 (BID023)' }],
      workType: [
        { value: '', text: '請選擇專業工程類別' },
        { value: '1', text: '1: BID024' },
      ],
      sworkType: [
        { value: '', text: '請選擇特定施工項目' },
        { value: '1', text: '1: BID025' },
      ],
      jobType: [
        { value: '', text: '請選擇技術士種類' },
        { value: '1', text: '1: BID026' },
      ],
      duty: [
        { value: '1', text: '1:在職' },
        { value: '2', text: '2:中途離職' },
    ...
    const submitForm = () => {
      ...
      navigateByNameAndParams('bidAac004Info', { bidProjectKey });
    };
