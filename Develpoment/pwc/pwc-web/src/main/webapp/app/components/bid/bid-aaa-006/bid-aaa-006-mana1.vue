    ...
    <div class="card">
      ...
      <b-form-row>
        ...
        <b-form-row>
         ...
         <div class="card">
        <div class="card-header">
            <h5 class="m-0">主管部會署或直轄市、縣市政府填報</h5>
        </div>
        <b-form-row>
        <i-form-group-check :label="'工程主管機關處理說明  '" :label-cols="4" :content-cols="8" class="col-6"><b-form-textarea class="col-6"></b-form-textarea></i-form-group-check>
        
        <i-form-group-check :label="'確認預估可付款日期   '" :label-cols="3" :content-cols="9" class="col-6">
            <b-form-radio-group :options="formOptions.duty"> </b-form-radio-group><i-date-picker placeholder="yyy/MM/dd" class="col-6"></i-date-picker>
        </i-form-group-check>
      </b-form-row>

       <b-form-row>
        <i-form-group-check :label="'結案日期  '" :label-cols="2" :content-cols="10" class="col-6">
            <i-date-picker placeholder="yyy/MM/dd" class="col-6"></i-date-picker><div style="color:red">(如已實際付款或屬已進入調解仲裁或訴訟案件且與爭議無關可再支付之金額均已支付  方可結案)</div>
        </i-form-group-check>
