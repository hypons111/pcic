    ...
    <section class="container">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <b-form-row>
            <!-- 機關名稱 -->
            <i-form-group-check labelStar content-cols="6" :label="$t('label.agencyName') + '：'" :item="$v.agencyName">
              <div v-if="formStatusRef === FormStatusEnum.READONLY">{{ $v.agencyName.$model }}</div>
              <b-form-input v-else v-model="$v.agencyName.$model" :state="validateState($v.agencyName)" trim lazy> </b-form-input>
            </i-form-group-check>
            <!-- 機關主管 -->
            <i-form-group-check labelStar content-cols="6" :label="$t('label.agencybos') + '：'" :item="$v.bos">
              <div v-if="formStatusRef === FormStatusEnum.READONLY">{{ $v.bos.$model }}</div>
              <b-form-input v-else v-model="$v.bos.$model" :state="validateState($v.bos)" trim lazy> </b-form-input>
            </i-form-group-check>
          </b-form-row>

          <b-form-row>
            <!-- 機關電話(一) -->
            <i-form-group-check labelStar content-cols="6" :label="$t('label.agencyTel1') + '：'" :item="$v.agencyTel1">
              <div v-if="formStatusRef === FormStatusEnum.READONLY">{{ $v.agencyTel1.$model }}</div>
              <b-form-input v-else v-model="$v.agencyTel1.$model" :state="validateState($v.agencyTel1)" trim lazy> </b-form-input>
            </i-form-group-check>
            <!-- 機關電話(二) -->
            <i-form-group-check labelStar content-cols="6" :label="$t('label.agencyTel2') + '：'" :item="$v.agencyTel2">
              <div v-if="formStatusRef === FormStatusEnum.READONLY">{{ $v.agencyTel2.$model }}</div>
              <b-form-input v-else v-model="$v.agencyTel2.$model" :state="validateState($v.agencyTel2)" trim lazy> </b-form-input>
            </i-form-group-check>
          </b-form-row>

          <b-form-row>
            <!-- 機關傳真 -->
            <i-form-group-check labelStar content-cols="6" :label="$t('label.agencyFax') + '：'" :item="$v.agencyFax">
              <div v-if="formStatusRef === FormStatusEnum.READONLY">{{ $v.agencyFax.$model }}</div>
              <b-form-input v-else v-model="$v.agencyFax.$model" :state="validateState($v.agencyFax)" trim lazy> </b-form-input>
            </i-form-group-check>
          </b-form-row>
