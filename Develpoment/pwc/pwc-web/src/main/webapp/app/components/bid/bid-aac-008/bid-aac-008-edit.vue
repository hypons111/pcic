  ...
  <div>
    ...
    <div class="card">
      <div class="card-header">
        <h5 class="m-0">規劃設計監造專技人員詳細資料</h5>
      </div>
      <b-form-row>
        <i-form-group-check :label="'初次提報日期: '" :label-cols="2" :content-cols="10" class="col-12">民國109年12月07日 </i-form-group-check>
      </b-form-row>
      <b-form-row>
        <i-form-group-check :label="'身分證號: '" :label-cols="2" :content-cols="10" class="col-12" :labelStar="true">
          <b-form-input class="col-4" ></b-form-input>
          <b-button class="btn-sm ml-1" @click="toCheck" style="background-color: #1aa4b7">審查專技人員</b-button>
          <b-button class="btn-sm ml-1" @click="toCheck" style="background-color: #1aa4b7">公共工程履歷</b-button>
        </i-form-group-check>
      </b-form-row>
      <b-form-row>
        <i-form-group-check :label="'姓名: '" :label-cols="2" :content-cols="10" class="col-12">余曉嵐 </i-form-group-check>
      </b-form-row>
      ...
      <b-form-row>
        <i-form-group-check :label="'現場人員專長: '" :label-cols="2" :content-cols="10" class="col-12" :labelStar="true">
          <b-form-input class="col-4"></b-form-input>
        </i-form-group-check>
      </b-form-row>
      <b-form-row>
        <i-form-group-check :label="'證照種類: '" :label-cols="2" :content-cols="10" class="col-12" :labelStar="true">
          <b-form-select :options="formOptions.company" class="col-4"></b-form-select>
        </i-form-group-check>
      </b-form-row>
      <b-form-row>
        <i-form-group-check :label="'證書編號: '" :label-cols="2" :content-cols="10" class="col-12" :labelStar="true">
          <b-form-input class="col-4"></b-form-input>
        </i-form-group-check>
      </b-form-row>
        <b-form-row>
            <i-form-group-check :label="'簽證項目: '" :label-cols="2" :content-cols="10" class="col-12" :labelStar="false">
                
                <b-form-checkbox :true-value="true" :false-value="false">設計</b-form-checkbox>
                <div class="d-inline">
        ...
        <b-form-row>
            <i-form-group-check :label="''" :label-cols="2" :content-cols="10" class="col-12" :labelStar="false">
                ...
                <b-form-checkbox :true-value="true" :false-value="false">監造</b-form-checkbox>
                <div class="d-inline">
                <i-dual-date-picker ></i-dual-date-picker>
                </div>
        ...
        <b-form-row>
            <i-form-group-check :label="'其他項目: '" :label-cols="2" :content-cols="10" class="col-12" :labelStar="false">
                
                <b-form-checkbox :true-value="true" :false-value="false">規劃</b-form-checkbox>
                <div class="d-inline">
                <i-dual-date-picker ></i-dual-date-picker>
                </div>
        ...
        <b-form-row>
            <i-form-group-check :label="''" :label-cols="2" :content-cols="10" class="col-12" :labelStar="false">
                ...
                <b-form-checkbox :true-value="true" :false-value="false">專案管理</b-form-checkbox>
                <div class="d-inline">
                <i-dual-date-picker ></i-dual-date-picker>
                </div>
      ...
      <b-form-row>
        <i-form-group-check :label="'受聘本工程起始日期: '" :labelStar="true">
          <i-date-picker placeholder="yyy/MM/dd" class="col-6"></i-date-picker>
        </i-form-group-check>
        <i-form-group-check :label="'受聘本工程結束日期: '">
          <i-date-picker placeholder="yyy/MM/dd" class="col-6"></i-date-picker>
        </i-form-group-check>
      </b-form-row>
