  ...
  setup() {
    ...
    const handleQuery = () => {
      checkValidity().then((isValid: boolean) => {
        if (isValid) {
          ...
          axios
            .post('/service/rec-projects/research', form)
            .then(({ data }) => {
    ...
    const table = reactive({
      fields: [
        ...
        {
          key: 'surveyPlanDate1',
          label: $i18n.t('label.surveyPlanDate1'),
          sortable: true,
          thClass: 'text-center',
          tdClass: 'text-center align-middle',
          formatter: value => (value == undefined ? '' : formatDate(new Date(value), '/')),
        ...
        {
          key: 'surveyPlanDate2',
          label: $i18n.t('label.surveyPlanDate2'),
          sortable: true,
          thClass: 'text-center',
          tdClass: 'text-center align-middle',
          formatter: value => (value == undefined ? '' : formatDate(new Date(value), '/')),
        ...
        {
          key: 'surveyPlanDate3',
          label: $i18n.t('label.surveyPlanDate3'),
          sortable: true,
          thClass: 'text-center',
          tdClass: 'text-center align-middle',
          formatter: value => (value == undefined ? '' : formatDate(new Date(value), '/')),
    ...
    const exportOds = () => {
      ...
      axios.post('/service/rec-projects/export-ods-research', form, { responseType: 'blob' }).then(response => {
