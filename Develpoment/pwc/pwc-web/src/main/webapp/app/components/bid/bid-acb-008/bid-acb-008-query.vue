      ...
      <i-table
        ...
        >
          ...
          <template #cell(binoculars)>
           ...
           <template #cell(proofInfo) >
        <a href="https://drive.google.com/drive/u/0/folders/1Zyg_sX_N2cpkm69sENCj64J8lGypCOfu"><u>XX工程有限公司</u></a>
      </template>
       <template #cell(checkMonth)="row" >
          <a href="http://localhost:9000/pwc-web/bidAcb008/detail" v-if="row.item.checkM=== '0' "><u> 1 </u></a>
<a href="http://localhost:9000/pwc-web/bidAcb008/detail" v-if="row.item.checkM=== '1' "><u> 2 </u></a>
<a href="http://localhost:9000/pwc-web/bidAcb008/detail" v-if="row.item.checkM=== '2' "><u> 3 </u></a>
<a href="http://localhost:9000/pwc-web/bidAcb008/detail" v-if="row.item.checkM=== '3' "><u> 4 </u></a>
<a href="http://localhost:9000/pwc-web/bidAcb008/detail" v-if="row.item.checkM=== '4' "><u> 5 </u></a>
<a href="http://localhost:9000/pwc-web/bidAcb008/detail" v-if="row.item.checkM=== '5' "><u> 6 </u></a>
<a href="http://localhost:9000/pwc-web/bidAcb008/detail" v-if="row.item.checkM=== '6' "><u> 7 </u></a>
<a href="http://localhost:9000/pwc-web/bidAcb008/detail" v-if="row.item.checkM=== '7' "><u> 8 </u></a>
<a href="http://localhost:9000/pwc-web/bidAcb008/detail" v-if="row.item.checkM=== '8' "><u> 9 </u></a>
      </template>
        </i-table>
