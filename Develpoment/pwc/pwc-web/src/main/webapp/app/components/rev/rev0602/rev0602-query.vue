        ...
        <div class="container" v-if="queryStatus">
          <b-collapse v-model="stepVisible">
            <table border="2" width="100%">
              <tr>
                <th width="20%" class="text-center">審議類別</th>
                <th width="20%" class="text-center">交通</th>
                <th width="20%" class="text-center">水利</th>
                <th width="20%" class="text-center">建築</th>
                <th width="20%" class="text-center">總計</th>
              </tr>

              <tr v-for="(item,key) in table.data">
                <td>{{item.cntType}}</td>
                <td class="text-right">{{item.cntTraffic}}</td>
                <td class="text-right">{{item.cntWater}}</td>
                <td class="text-right">{{item.cntBuilding}}</td>
