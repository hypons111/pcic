        ...
        <div class="card-body col-10">
          <b-form-row>
            <i-form-group-check :label="$t('label.isForwardPlan') + '：'" :labelStar="true">
              <b-form-checkbox :true-value="true" :false-value="false"></b-form-checkbox>
            </i-form-group-check>
          ...
          <b-form-row>
            ...
            <i-form-group-check :label="$t('label.reserveDate') + '：'" :item="$v.reserveDate" :labelStar="true">
              <i-date-picker
                v-model="$v.reserveDate.$model"
                :state="validateState($v.reserveDate)"
                :disabled="formStatusForwardProp === formStatusEnum.INFO"
              ></i-date-picker>
            </i-form-group-check>
          </b-form-row>
          ...
          <b-form-row>
            <i-form-group-check :label="$t('label.planManual') + '：'" :item="$v.planManual">
              <b-form-file
                ...
                browse-text="選擇檔案"
                :placeholder="$v.planManual.$model ? $v.planManual.name : ''"
                :disabled="formStatusForwardProp === formStatusEnum.INFO"
              ></b-form-file>
            </i-form-group-check>
