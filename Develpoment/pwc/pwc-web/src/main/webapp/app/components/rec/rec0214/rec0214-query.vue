<template>
  <div>
        ...
        <div class="card-body col-11">
          <b-collapse v-model="stepVisible.step1">
            ...
            <b-form-row>
              ...
              <!--金額-->
               <i-form-group-check label="金額(千元):" :labelStar="true">
                    <form class="form-inline">
                    <b-form-input type="number" min=0 class="form-group"></b-form-input>
                    <p class="form-group">(起) ~</p>
                    <b-form-input type="number" min=0 class="form-group"></b-form-input>
                    <p class="form-group">(迄)</p>
                    </form>
                </i-form-group-check>
            </b-form-row>
    ...
    <section class="container mt-2" v-if="queryStatus">
      <p style="text-align:center">經費範圍1000~5000災後復建工程統計一覽表</p>
      <b-table
        bordered
        striped
        ...
        if (isValid) {
          ...
          table.data = [
            ...
            },
            {
              countyGov: '嘉義縣政府',
              aprvdBdgt: '48,967',
              unctrkdAprvdBdgt: '19,106',
              ctrkdAprvdBdgt: '25,688',
              exedNum: '15,681',
              successRt: '61.05%',
              aprvdCases: '18', 
              ctrkdCases: '12',
            ...
            },
            {
              countyGov: '合計',
              aprvdBdgt: '64,867',
              unctrkdAprvdBdgt: '33,740',
              ctrkdAprvdBdgt: '26,654',
              exedNum: '15,681',
              successRt: '58.83%',
              aprvdCases: '26', 
              ctrkdCases: '13',
