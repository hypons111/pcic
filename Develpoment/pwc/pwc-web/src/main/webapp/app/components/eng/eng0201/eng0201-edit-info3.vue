...
<div>
  ...
  <b-form-row>
    <b-col offset="5">
      ...
      <!-- 新增 -->
      <i-button type="file-earmark-plus" @click="toEditView('Eng0201EditInfo3_1', FormStatusEnum.CREATE)"> </i-button>
    </b-col>
  </b-form-row>
  ...
  <section class="container mt-2" v-show="queryStatus">
    <i-table
      ...
      <template #cell(action)="row">
        <!-- 編輯 -->
        <i-button @click="toEditView('Eng0201EditInfo3_1', FormStatusEnum.EDIT, row.index)"
            v-if="
    ...
    const data = [
      {
        idno: 'F100012321',
        name: '曹百利',
        engCompMemberType: '總經理',
        tel: '0912321321',
        isEngr: '否',
        inDateStart: '2020-11-10',
        inDateEnd: ''
      },
    ]
