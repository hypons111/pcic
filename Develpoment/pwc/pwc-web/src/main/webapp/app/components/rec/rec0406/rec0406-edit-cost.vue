        ...
        <b-row align-h="center">
          <b-col cols="11">
            ...
            <table width="40%">
              ...
              <tr>
                <td>調整經費</td>
                <td><b-form-input v-model="$v.requestAmount.$model" :state="validateState($v.requestAmount)"></b-form-input></td>
                <td>（千元）</td>
              </tr>
            </table>
            <table width="80%">
              <tr>
                ...
                <td><b-form-textarea v-model="$v.requestReason.$model" rows="4" maxlength="4000" placeholder="調整經費說明"></b-form-textarea></td>
              </tr>
            </table>
          </b-col>
        </b-row>
