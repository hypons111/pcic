          ...
          <b-col cols="11">
            <table width="100%">
              <tr>
                ...
                <td width="20%"><b-form-input v-model="$v.approveAmount.$model" disabled></b-form-input></td>
                <td width="65%">（千元）</td>
              </tr>
              <tr>
                <td width="15%">完工期限</td>
                <td width="20%"><b-form-input v-model="$v.approveFinishDate.$model" disabled></b-form-input></td>
                <td width="65%"></td>
              </tr>
            </table>
            <table width="100%">
              <tr>
                ...
                <td width="30%"><b-form-select v-model="$v.requestReasonList.$model" :options="queryOptions.requestReasonList" :state="validateState($v.requestReasonList)" disabled></b-form-select></td>
                <td width="55%"></td>
              </tr>
            </table>
            <table width="100%">
              <tr>
                <td width="15%">意見</td>
                <td><b-form-textarea v-model="$v.approveOpinion.$model" rows="4" maxlength="4000" placeholder="審核意見" disabled></b-form-textarea></td>
              </tr>
            </table>
          </b-col>
        </b-row>
