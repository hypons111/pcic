...
export default {
  ...
  setup(props) {
    ...
    function toLast() {
      navigateByNameAndParams('Eng0303Query', {
    ...
    const engrTable = reactive({
      fields: [
        ...
        },
        {
          ...
          thStyle: 'width:20%',
          thClass: 'text-center',
          tdClass: 'left-center align-middle ',
        },
        {
          // 簽證範圍
          key: 'recordRangeList',
    ...
    const data = {
      caseNum: 'A9907',
      caseType: '機關自辦',
      caseNa: '頭前溪河口段浮覆地填築工程(含北河道及北寮嶼挖除)',
      orgId: '3.13.20.12',
      orgName: '經濟部水利署第二河川局',
      execOrgId: '3.13.20.12',
      wkutName: '經濟部水利署第二河川局',
      contactPerson: '工務課',
      contactTel: '03-5322334#216',
      tenderDate: '98/07/28',
      ctSum: 0,
      execDateStart: '99/07/28',
      execDateEnd: '101/01/18',
