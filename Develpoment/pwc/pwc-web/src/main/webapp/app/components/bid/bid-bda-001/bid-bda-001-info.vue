<template>
  <div>
    <div class="d-flex justify-content-center">
                <div  style="color: black">公共工程延遲付款廠商通報</div>
                
              </div>
              <div class="d-flex justify-content-center">
                <div  style="color: black"><a href="https://bootstrap-vue.org/docs/components/form-input"><u>各部會暨地方政府公共工程延遲付款通報案件排行榜(pdf)</u></a></div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <b-collapse v-model="stepVisible.step1">
            <b-form-row>
              <b-form-group class="col-sm-5" label-cols-md="3" content-cols-md="9" label="標案名稱關鍵字" label-align-md="right">
                <b-form-input ></b-form-input>
              </b-form-group>
              <b-form-group class="col-sm-5" label-cols-md="3" content-cols-md="9" label="標案編號" label-align-md="right">
                <b-form-input ></b-form-input>
              </b-form-group>
              <div  style="color: red;font-size:small;">(查詢條件擇一輸入，即可查詢)</div>
              <b-col cols="2">
      ...
      <i-table
        ...
        >
          ...
          <template #cell(action)>
            <b-button class="btn-sm" style="background-color: #1aa4b7">新增通報</b-button>
            <b-button class="btn-sm" style="background-color: #1aa4b7">查詢處理情形</b-button>
          </template>
        </i-table>
    </div>
  </div>
