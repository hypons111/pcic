<template>
  <div>
      ...
      <div class="card">
        ...
        <div class="card-body col-11">
          <b-collapse v-model="stepVisible.step1">
            ...
            <b-form-row>
              <!--發包日-->
               <i-form-group-check label="發包日:" :labelStar="false">
            ...
            <b-form-row>
                <!--完工日-->
                <i-form-group-check label="完工日:" :labelStar="false">
                    <i-dual-date-picker></i-dual-date-picker>
                </i-form-group-check>
            </b-form-row>
    ...
    <section class="container mt-2" v-if="queryStatus">
      <p style="text-align:center">自選經費範圍之執行統計一覽表</p>
      <b-table
        bordered
        striped
          ...
          table.data = [
            {
              countyGov: '南投縣政府',
              aprvdBdgt: '170,765',
              unctrkdAprvdBdgt: '1,682',
              ctrkdAprvdBdgt: '136,144',
              exedNum: '114,066',
              successRt: '83,78%',
              aprvdCases: '71', 
              ctrkdCases: '67',
            ...
            },
            {
              countyGov: '苗栗縣政府',
              aprvdBdgt: '52,312',
              unctrkdAprvdBdgt: '47,431',
              ctrkdAprvdBdgt: '4,506',
              exedNum: '3,921',
              successRt: '87.01%',
              aprvdCases: '25', 
              ctrkdCases: '8',
            ...
            },
            {
              countyGov: '雲林縣政府',
              aprvdBdgt: '356,869',
              unctrkdAprvdBdgt: '115,519',
              ctrkdAprvdBdgt: '353,346',
              exedNum: '250,767',
              successRt: '70.97%',
              aprvdCases: '56', 
              ctrkdCases: '44',
            ...
            },
            {
              countyGov: '嘉義縣政府',
              aprvdBdgt: '257,327',
              unctrkdAprvdBdgt: '75,957',
              ctrkdAprvdBdgt: '156,847',
              exedNum: '114,629',
              successRt: '73.08%',
              aprvdCases: '67', 
              ctrkdCases: '55',
            ...
            },
            {
              countyGov: '合計',
              aprvdBdgt: '837,273',
              unctrkdAprvdBdgt: '240,589',
              ctrkdAprvdBdgt: '650,843',
              exedNum: '483,383',
              successRt: '74.27%',
              aprvdCases: '219', 
              ctrkdCases: '174',
