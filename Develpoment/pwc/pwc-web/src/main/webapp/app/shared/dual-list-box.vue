  ...
  <div class="list-box-wrapper">
    <div class="list-box-item">
      <div class="search-box">
        <input v-model="searchSource" type="text" placeholder="輸入關鍵字搜尋..." :disabled="disabled" />
    ...
    <div class="list-box-item">
      <div class="search-box">
        <input v-model="searchDestination" type="text" placeholder="輸入關鍵字搜尋..." :disabled="disabled" />
