...
import ITableLite from '@/shared/i-table/i-table-lite.vue';
...
import IAddressPicker from './shared/i-address-picker/i-address-picker.vue';
...
Vue.component('i-table-lite', ITableLite);
