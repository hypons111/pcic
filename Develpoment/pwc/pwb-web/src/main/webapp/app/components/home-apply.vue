...
<script lang="ts">
import { computed, defineComponent, inject, onMounted, reactive, ref, watch } from '@vue/composition-api';
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    function getAllUnitOpts() {
      axios
        .get('/service/adm-units/get-unit-opts')
        .then(({ data }) => {
    ...
    function getAllRoles() {
      axios
        .get(`/service/adm-role/get-role-opts`)
        .then(({ data }) => {
