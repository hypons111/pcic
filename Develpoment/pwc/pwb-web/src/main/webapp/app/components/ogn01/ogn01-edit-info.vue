...
export default {
  ...
  setup(props, context) {
    ...
    const toQueryView = () => {
      context.emit('changeComponent', 'Ogn01Query', isReload.value);
    };
